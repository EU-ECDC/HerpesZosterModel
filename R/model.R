...
FOI <- function(age, y, rij, muy, N, D, Lmax, A, startpar,
  ...
  qproc <- function(age, y, qpar, rij, Lmax, N, D, prop_fac = prop){
  ...
  q.result <- nlm(function(qpar){return(qproc(age, y, qpar, rij, Lmax, N, D)$ll)},
